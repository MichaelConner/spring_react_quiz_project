...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        questionAnswerRepository.save(Q7);
        ...
        questionAnswerRepository.save(Q15);
        ...
        questionAnswerRepository.save(Q16);
        ...
        questionAnswerRepository.save(Q17);
        ...
        questionAnswerRepository.save(Q25);
        ...
        questionAnswerRepository.save(Q28);
        ...
        questionAnswerRepository.save(Q29);
        ...
        questionAnswerRepository.save(Q30);
        ...
        questionAnswerRepository.save(Q34);
        ...
        questionAnswerRepository.save(Q35);
        ...
        questionAnswerRepository.save(Q36);
